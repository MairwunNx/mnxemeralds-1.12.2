package com.mairwunnx.mnxemeralds.tiles;
...
public class TileEntityEmeraldChest  extends TileEntityLockableLoot implements ITickable
{
    ...
    {
        return this.hasCustomName() ? this.customName : "container.emerald_chest";
    }
