...
public class EmeraldChest extends BlockContainer
{
    ...
    public EmeraldChest(String name, float hardness, float resistance)
    {
        super(Material.IRON);
    ...
    public ILockableContainer getContainer(World worldIn, BlockPos pos, boolean allowBlocking)
    {
        ...
        {
            ILockableContainer ilockablecontainer = (TileEntityEmeraldChest)tileentity;
    ...
    public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityEmeraldChest)
            {
                i = ((TileEntityEmeraldChest)tileentity).numPlayersUsing;
            }
