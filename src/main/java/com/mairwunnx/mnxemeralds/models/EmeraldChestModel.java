package com.mairwunnx.mnxemeralds.models;
...
public class EmeraldChestModel  extends ModelBase
{
    /** The chest lid in the chest's model. */
    private final ModelRenderer chestLid = (new ModelRenderer(this, 0, 0)).setTextureSize(64, 64);
    /** The model of the bottom of the chest. */
    private final ModelRenderer chestBelow;
    /** The chest's knob in the chest model. */
    private final ModelRenderer chestKnob;

    public EmeraldChestModel()
    {
